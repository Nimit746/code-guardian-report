...
export const FileDropZone: React.FC<FileDropZoneProps> = ({ onFileSelect }) => {
  ...
  return (
    <div
      className={`group relative overflow-hidden rounded-2xl border-3 border-dashed p-6 text-center transition-all duration-300 focus-within:ring-2 focus-within:ring-primary focus-within:ring-offset-2 sm:p-8 lg:p-12 ${
        isDragOver
          ? "scale-105 border-primary bg-muted/50 dark:from-blue-950/50 dark:to-indigo-950/50"
          : "border-border hover:border-primary hover:bg-muted hover:from-slate-50 hover:to-blue-50 dark:border-slate-600 dark:hover:border-primary dark:hover:from-slate-800/50 dark:hover:to-blue-900/50"
      }`}
