...
export function PWAInstallPrompt() {
  ...
  return (
    <Card className="animate-in slide-in-from-bottom-2 fixed right-4 bottom-4 z-50 max-w-sm border-0 bg-slate-900 p-4 text-white shadow-2xl dark:bg-slate-950">
