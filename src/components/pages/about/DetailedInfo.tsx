        ...
        <div className="mx-auto max-w-5xl">
          <div className="mb-16 text-center">
            ...
            <div className="mb-12 flex flex-wrap justify-center gap-6">
              ...
              <div className="group border-border/50 hover:shadow-primary/10 flex cursor-pointer items-center gap-3 rounded-2xl border bg-gradient-to-r from-blue-100/80 to-cyan-100/80 px-6 py-3 backdrop-blur-sm transition-all duration-300 hover:shadow-lg dark:border-blue-700/50 dark:from-blue-900/40 dark:to-cyan-900/40">
                <Star className="text-primary dark:text-primary h-5 w-5 transition-transform duration-300 group-hover:scale-110" />
              ...
              <div className="group flex cursor-pointer items-center gap-3 rounded-2xl border border-purple-200/50 bg-gradient-to-r from-purple-100/80 to-pink-100/80 px-6 py-3 backdrop-blur-sm transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/20 dark:border-purple-700/50 dark:from-purple-900/40 dark:to-pink-900/40">
                <Globe className="text-primary h-5 w-5 transition-transform duration-300 group-hover:scale-110" />
                <span className="text-primary text-sm font-semibold">
                  Multi-Language
                </span>
              </div>
          ...
          <div className="bg-card rounded-lg p-8 shadow-sm">
            ...
            <div className="border-border bg-muted dark:border-border mt-8 rounded-lg border p-6 dark:from-blue-950 dark:to-indigo-950">
