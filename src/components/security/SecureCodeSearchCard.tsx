  ...
  return (
    ...
    >
      <CardHeader>
        ...
        <CardDescription>
          Search for secure code implementations and learn from security best
          practices
        </CardDescription>
      </CardHeader>
            ...
            <div className="grid grid-cols-1 gap-4 rounded-lg bg-muted p-4 md:grid-cols-3 lg:grid-cols-5">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  updateFilter(
                    "securityLevel",
                    value as "secure" | "insecure" | "improved" | undefined
                  )
                }
              >
                <SelectTrigger>
                          ...
                          <div>
                            ...
                            <div className="space-y-2 text-sm">
                              <div className="flex items-center gap-2">
                                ...
                                <span>
                                  Updated:{" "}
                                  {result.snippet.lastUpdated.toLocaleDateString()}
                                </span>
                              </div>
                              <div className="flex items-center gap-2">
